...
(define/contract (init)
  (-> any)
  (current-scheme/host "http://www.kaashif.co.uk")
  (current-uri-prefix "/")
  (current-title "kaashif's blog")
  (current-author "Kaashif Hymabaccus")
