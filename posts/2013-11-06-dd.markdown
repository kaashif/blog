...
comment: A quick tutorial on how to zero a disk drive on GNU/Linux, using only GNU coreutils. You can even zero the drive multiple times to get the full Dban experience, all without booting into some unfamiliar environment.
date: 2013-11-06
---


This article is not only about disk wiping, it will hopefully teach you
something about using Unix (not just GNU/Linux, necessarily) command line tools
in general. This tutorial was written on my ThinkPad, which runs Debian, so the
output should be pretty similar to what you'd get on Ubuntu, Mint or any other
Debian- or Ubuntu-based systems. Basically, if you're using something
non-standard, you already know that you are, since those types of operating
