...
comment: Using Pod to generate groff manual pages. A bit more user-friendly than writing the horrible macros out by hand.
date: 2014-01-08
---
...
date. If a program does end up being useful to me, but has no manual page, I
