...
The idea of the circuit is the same, close SW1 to charge, open it,
...
It goes without saying that you should use a ton of wire, otherwise
...
time constant slowing down your projectile, don't make R too large.

## Where to now?

I would do some calculations and measurements to work out how good my
...
speeds and maybe something worth making a video about.

I'll also have learnt something about how to make a practical
high-speed switching circuit with a photodiode, IR LED and maybe IGBTs
instead of SCRs (thyristors), since IGBTs can be turned off.
