...
And gcc doesn't always perform NRVO, even if it "obviously" can. Why?
Do other compilers do better? Is there any way for the standard to
require NRVO?
...
Let's look at code sample to see what the problem isn't, i.e. an
...
This doesn't refer to NRVO! Assuming NRVO can be very dangerous and
result in copies of huge objects, and hurt performance a lot.
